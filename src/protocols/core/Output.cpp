...
void CWLOutputResource::updateState() {
    ...
    resource->sendGeometry(monitor->m_position.x, monitor->m_position.y, monitor->m_output->physicalSize.x, monitor->m_output->physicalSize.y,
                           (wl_output_subpixel)monitor->m_output->subpixel, monitor->m_output->make.c_str(), monitor->m_output->model.c_str(), monitor->m_transform);
